...
- Current GPT file: `16_prosody_phonetics_sound_engine.md`
- Purpose: Prosody, phonetics, lyric sound engine
- Preserved source aliases: 14_PROSODY_AND_PHONETICS, 25_LYRIC_SOUND_ENGINE
- Use rule: Use for syllable density, mora, sinalefa, stress, linking, diction, Suno realization. Together: language lyric file+03.
...
# SOURCE: 14_PROSODY_AND_PHONETICS.md
...
# SOURCE: 25_LYRIC_SOUND_ENGINE.md
