...
- Current GPT file: `02_suno_engine_create_cover.md`
- Purpose: Suno CREATE/COVER engine
- Preserved source aliases: 09_SUNO_ENGINE
- Use rule: Use for CREATE=bones, COVER=re-render, Audio Influence, 7/8-field mechanics. Together: 05,06,03.
...
# Active GPT patch: CREATE/COVER and COVER prompt order
COVER is not a new song: it re-renders the CREATE audio. For Genre-Transform, always order the prompt as target genre micro-anchor -> preserve map -> substitution map -> vocal identity -> section/energy events -> full quality stack -> throughout/final/outro preservation. Quality is mandatory but must not replace the genre anchor. Never use meta phrases like "mix support sits after the transformation."

---

# SOURCE: 09_SUNO_ENGINE.md
