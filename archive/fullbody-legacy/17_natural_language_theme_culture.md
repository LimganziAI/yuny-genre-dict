...
- Current GPT file: `17_natural_language_theme_culture.md`
- Purpose: Natural language direction, theme and culture
- Preserved source aliases: 15_NATURAL_LANGUAGE_DIRECTION, 17_THEMATIC_CULTURAL_ENGINE
- Use rule: Use for turning plain-language mood/theme/culture into musical decisions and concrete imagery. Together: language lyric file,05.
...
# SOURCE: 15_NATURAL_LANGUAGE_DIRECTION.md
...
# SOURCE: 17_THEMATIC_CULTURAL_ENGINE.md
...
# === END 17 USER EXTENSION ZONE v2.0 ===
