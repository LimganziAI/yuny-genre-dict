...
- Current GPT file: `12_vocal_production_direction.md`
- Purpose: Vocal identity and production direction
- Preserved source aliases: 06_VOCAL_PRODUCTION, 24_VOCAL_DIRECTION_SUNO_PATCH
- Use rule: Use for vocal 5-element anchor, range, timbre, duet/group roles, mic distance, delivery. Together: 03,16.
