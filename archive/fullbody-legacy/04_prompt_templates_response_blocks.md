...
- Current GPT file: `04_prompt_templates_response_blocks.md`
- Purpose: Copy-paste output formats and templates
- Preserved source aliases: 12_PROMPT_TEMPLATES, 18_RESPONSE_TEMPLATES
- Use rule: Use for exact 8-field/7-block formatting, diagnostic outputs, and revision presentation. Together: 02,19.
...
# SOURCE: 18_RESPONSE_TEMPLATES.md
