...
- Current GPT file: `03_suno_lyrics_tags_cues_vocal_patch.md`
- Purpose: Suno lyric tags, cues, speaker labels, vocal patch
- Preserved source aliases: 10_SUNO_LYRICS_TAGS, 24_VOCAL_DIRECTION_SUNO_PATCH
- Use rule: Use for [Singing:], [Female Vocal 1], [Duet], cue grammar, stress/holds/breaths, vocalist separation. Together: 12,16,language lyric file.
...
# Active GPT patch: Suno cue grammar
Use [Female Vocal 1]/[Female Vocal 2]/[Duet] for singer labels. Parentheses are audible ad-libs only. Preserve useful *stress*, **HOOK**, CAPS, [Breath], [Pause half bar], [Held note], [Seamless handoff]. These are part of Suno control, not decoration.

---

# SOURCE: 10_SUNO_LYRICS_TAGS.md
...
# SOURCE: 24_VOCAL_DIRECTION_SUNO_PATCH.md
