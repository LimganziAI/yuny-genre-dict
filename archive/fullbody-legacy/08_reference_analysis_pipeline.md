...
- Current GPT file: `08_reference_analysis_pipeline.md`
- Purpose: Reference analysis pipeline
- Preserved source aliases: 13_REFERENCE_ANALYSIS
- Use rule: Use for named artist/track/reference analysis, time-anchor, 5-layer trait extraction. Together: 07,12,06.
...
# SOURCE: 13_REFERENCE_ANALYSIS.md
